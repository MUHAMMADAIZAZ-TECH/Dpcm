  ...
  return (
    <div className='bg-no-repeat bg-cover' style={{ backgroundImage: `url(${backgroundImg})`, height: '100vh' }}>
     ...
     <div className="mx-36 my-28 flex flex-col">
        ...
        <h3 className='text-white text-3xl'>furkan nazeer</h3>
        <h3 className='text-white text-3xl'>dpcm222@gmail.com</h3>
        <h3 className='text-white text-3xl'>karimabad Lahore</h3>
        <h3 className='text-white text-3xl'>03174232352</h3>
      </div>
